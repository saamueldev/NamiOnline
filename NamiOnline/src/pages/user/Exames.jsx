...
export default function Exames() {
  ...
  function selecionarExame(exame) {
    fecharDetalhesExame()
    navigate(`/exames/agendar/${exame._id}`)
  }
            ...
            <div className="flex items-start justify-between gap-4 bg-gradient-to-r from-[#132190] to-[#004AF7] px-6 py-6">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-white/80">
                  Confira os principais detalhes antes de prosseguir com o agendamento.
                </p>
              </div>
            ...
            <div className="px-6 py-6">
              ...
              <div className="mt-4 rounded-2xl border border-[#87B7FE]/25 bg-[#E4F2FE]/60 p-4">
                ...
                <ul className="mt-3 space-y-2 text-sm leading-6 text-slate-600">
                  {exameDetalhado.guiaNecessaria ? (
                    <li>• Este exame exige guia médica para prosseguir com o agendamento.</li>
                  ) : (
                    <li>• Este exame não exige guia médica para solicitação inicial.</li>
                  )}

                  <li>• A confirmação depende da disponibilidade de horários.</li>
                  <li>• No dia do atendimento, leve documento com foto.</li>
                </ul>
              </div>
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-end">
                ...
                <button
                  type="button"
                  onClick={() => selecionarExame(exameDetalhado)}
                  className="rounded-xl bg-[#004AF7] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#132190]"
                >
                  Selecionar exame
                </button>
